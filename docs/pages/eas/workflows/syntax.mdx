...
| `corepack`  | Whether to enable corepack.                                                |
...
| `group`              | `string`  | We do not support custom concurrency groups yet. Please set this placeholder value so when we do support custom groups your workflow remains compatible. |
